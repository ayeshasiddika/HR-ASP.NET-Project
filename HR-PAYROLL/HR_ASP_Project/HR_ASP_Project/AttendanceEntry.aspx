<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AttendanceEntry.aspx.cs" Inherits="HR_ASP_Project.AttendanceEntry" %>
        ...
        <div id="entryTable">
            <div id="deptEntry">
                ...
                <div class="form-group">
                   ...
                   <uc1:Calender1 runat="server" ID="calAttendance" />
                </div>
