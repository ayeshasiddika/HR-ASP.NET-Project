<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="BenefitRecord.aspx.cs" Inherits="HR_ASP_Project.BenefitRecord" %>

<%@ Register Src="~/Calender1.ascx" TagPrefix="uc1" TagName="Calender1" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div class="col-md-12">
        <h2>Benefit Record</h2>
        <div id="entry">
            <div id="mainEntryArea">
                ...
                <div class="form-group">
                    ...
                    <uc1:Calender1 runat="server" ID="calBenefitDate" />
                </div>
